...
IF :NEW.STATUS IS NOT NULL THEN
    IF :NEW.STATUS != 'IN WAY' OR :NEW.STATUS != 'ARRIVED' OR :NEW.STATUS != 'COMPLETED' OR :NEW.STATUS != 'IN ASSEMBLY' OR :NEW.STATUS != 'В ПУТИ'
    OR :NEW.STATUS != 'ПРИБЫЛ' OR :NEW.STATUS != 'ЗАВЕРШЁН' OR :NEW.STATUS != 'НА СБОРКЕ' THEN
        RAISE ORD_EX;
    END IF;
END IF;
EXCEPTION
