...
-- UPDATE BIKE 
    ...
    BEGIN
    UPDATE BIKES SET BIKE_NAME = NAME,PRICE=COST,CATEGORY_ID = CAT WHERE BIKE_ID = BIKE AND SELLER_ID = USER
...
-- DELETE BIKE
    ...
    BEGIN
        ...
        DELETE FROM BIKES WHERE BIKE_ID = BIKE AND SELLER_ID = USER
...
-- UPDATE ORDER
    ...
    BEGIN
        ...
        ORDER_DATE = ODATE,
        STATUS = STAT 
        WHERE ORDER_ID = ORD AND BUYER_ID = BUYER AND BIKE_ID = BIKE
...
-- DEL ORDER
    ...
    BEGIN
        DELETE FROM ORDERS WHERE ORDER_ID = ORD AND BUYER_ID = USER
...
BEGIN
    IF BIKE IS NOT NULL THEN
        DELETE FROM RATINGS WHERE BIKE_ID = BIKE AND USER_ID = USER;
    ELSE
        RAISE NO_DATA_FOUND;
    END IF;
EXCEPTION
