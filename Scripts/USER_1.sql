...
--пецхярпюжхъ
BEGIN
 DBMS_OUTPUT.PUT_LINE(DEVELOPER.REGISTER('VLADISLAV','LEMIASHEUSKY','OLEGOVICH','VLAD.LEMESHOK@GMAIL.COM','12345','25-04-2004','MINSK',1));
 COMMIT;
END;
...
BEGIN
 DBMS_OUTPUT.PUT_LINE(DEVELOPER.LOGIN('user1@example.com','password1'));
 COMMIT;
END;
