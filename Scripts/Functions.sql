...
BEGIN
    DBMS_OUTPUT.PUT_LINE(AVG_RATE(1));
END;
...
BEGIN
    DBMS_OUTPUT.PUT_LINE(REGISTER('DIM13131132313A','NEDIMA','OLEG','DIMA.LE13M123ESHOK@GMAIL.COM' , '13' , '25-05-2034','mINSK' , 1));
END;
...
-- ADD RATE
    ...
    BEGIN
        DBMS_OUTPUT.PUT_LINE(ADD_RATE(1,2,2,'BAD!',SYSTIMESTAMP));
    END;
