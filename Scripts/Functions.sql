...
BEGIN
    DBMS_OUTPUT.PUT_LINE(REGISTER('VLAD','LEMESH','OLEG','DIMA.LEMESHOK@GMAIL.COM' , '12345' , '25-05-2004','mINSK' , 1));
END;
...
-- ADD RATE
    ...
    BEGIN
        DBMS_OUTPUT.PUT_LINE(ADD_RATE(2,2,6,'NOT BAD!',SYSTIMESTAMP));
    END;
